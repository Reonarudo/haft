    ...
    public:
                ...
                case Instruction::Call: {
                    ...
                    if (isCallToOutside(func)) {
                        ...
                        if (InvokeInst* invoke = dyn_cast<InvokeInst>(I)) {
                            ...
                            insertTxStart((Instruction*)std::next(instIt));
                        }
                    } else {
                        ...
                        if (InvokeInst* invoke = dyn_cast<InvokeInst>(I)) {
                            ...
                            insertCondTxStart((Instruction*)std::next(instIt));
                        }
                    }
        ...
        void visitBasicBlock(BasicBlock* BB) {
            ...
            for (BasicBlock::iterator bi = BB->begin(); bi != BB->end(); ) {
                ...
                visitInst((Instruction*)bi, instIdx);
                bi = nextbi;
                instIdx++;
            }
        }
        ...
        void insertChecksOnLoopHeaders(Loop* L) {
            ...
            for (BasicBlock::iterator I = (BasicBlock::iterator)header->getFirstNonPHI(); I != header->end(); I++) {
        ...
        void optimizeCriticalSections(Function &F) {
            ...
            for (Function::iterator BB = F.begin(), BE = F.end(); BB != BE; ++BB)
                for (auto II = BB->begin(), IE = BB->end(); II != IE; ++II) {
                    if (isCallToFunc((Instruction*)II, "pthread_mutex_lock"))
                        analyzeCriticalSection((Instruction*)II);
                }
